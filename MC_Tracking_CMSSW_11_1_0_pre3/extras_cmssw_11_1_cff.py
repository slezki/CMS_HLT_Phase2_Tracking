...
PixelCPEGenericESProducer = cms.ESProducer("PixelCPEGenericESProducer",
    ...
    DoLorentz = cms.bool(False), # cmssw_11_1
    EdgeClusterErrorX = cms.double(50.0),
    EdgeClusterErrorY = cms.double(85.0),
    IrradiationBiasCorrection = cms.bool(False), # cmssw_11_1 pixelcpe issue needs to be True
    LoadTemplatesFromDB = cms.bool(False), # cmssw_11_1 pixelcpe issue needs to be True
    MagneticFieldRecord = cms.ESInputTag("", ""), # cmssw_11_1 previous ""
    SmallPitch = cms.bool(False), # cmssw_11_1
    #PixelErrorParametrization = cms.string('NOTcmsim'), #commented out for cmssw_11_1
    TruncatePixelCharge = cms.bool(False), # cmssw_11_1 pixelcpe issue needs to be True
    Upgrade = cms.bool(True),
    appendToDataLabel = cms.string(''),
    UseErrorsFromTemplates = cms.bool(False), # cmssw_11_1 pixelcpe issue needs to be True
    ...
    lAOffset = cms.double(0), # cmssw_11_1
    lAWidthBPix = cms.double(0), # cmssw_11_1
    lAWidthFPix = cms.double(0), # cmssw_11_1
    size_cutX = cms.double(3.0),
    size_cutY = cms.double(3.0),
    useLAAlignmentOffsets = cms.bool(False),
    useLAWidthFromDB = cms.bool(True) # cmssw_11_1 previous False
)
...
hltESPPixelCPEGeneric = cms.ESProducer("PixelCPEGenericESProducer",
    ...
    #PixelErrorParametrization = cms.string('NOTcmsim'), # commented out for cmssw_11_1
    #TanLorentzAnglePerTesla = cms.double(0.106), # commented out for cmssw_11_1
...
hltESPPixelCPETemplateReco = cms.ESProducer("PixelCPETemplateRecoESProducer",
    ...
    #DoCosmics = cms.bool(False), # commented out for cmssw_11_1
    LoadTemplatesFromDB = cms.bool(True),
