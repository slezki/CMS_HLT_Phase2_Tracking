...
from DQMOffline.Configuration.DQMOfflineMC_cff import TrackSplitMonitor, dqmInfoTracking
"""

from DQMOffline.Configuration.DQMOfflineMC_cff import *

hltPhase2PV0p1 = cms.EDProducer("TrackWithVertexSelector",
...
hltPhase2TrackMon_ckf = cms.EDProducer("TrackEfficiencyMonitor",
...
hltPhase2TrackSeedMonhighPtTripletStep = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
        ("AbsDxyMin" , cms.double(0.0) ),
        ("AlgoName" , cms.string('hltPhase2HighPtTripletStep') ),
...
hltPhase2TrackSeedMoninitialStep = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
**dict(
    [
        ...
        ("SeedHitMax" , cms.double(5.5) ),
        ("SeedHitMin" , cms.double(-0.5) ),
        ("SeedProducer" , cms.InputTag("hltPhase2L1TrackSeedsFromL1Tracks") ),
        ("TCDxyBin" , cms.int32(100) ),
        ("TCDxyMax" , cms.double(100.0) ),
        ("TCDxyMin" , cms.double(-100.0) ),
        ("TCDzBin" , cms.int32(100) ),
        ...
        ("TCHitMax" , cms.double(39.5) ),
        ("TCHitMin" , cms.double(-0.5) ),
        ("TCProducer" , cms.InputTag("hltPhase2L1CtfTracks") ),
        ("TCSizeBin" , cms.int32(200) ),
        ("TCSizeMax" , cms.double(999.5) ),
        ("TCSizeMin" , cms.double(-0.5) ),
        ("TECLayBin" , cms.int32(15) ),
...
hltPhase2TrackerCollisionSelectedTrackMonCommongeneralTracks = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
hltPhase2TrackerCollisionSelectedTrackMonCommonhighPurityPV0p1 = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
hltPhase2TrackerCollisionSelectedTrackMonCommonhighPurityPt1 = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
        ...
        ("TrackPMax" , cms.double(100.0) ),
        ("TrackPMin" , cms.double(0.0) ),
        ("TrackProducer" , cms.InputTag("hltPhase2HighPurityPt1") ),
        ("TrackProducerForMVA" , cms.InputTag("hltPhase2InitialStepTracks") ),
        ("TrackPt2DBin" , cms.int32(100) ),
        ("TrackPtBin" , cms.int32(100) ),
        ("TrackPtMax" , cms.double(100.0) ),
...
**dict(
    [
        ...
        ("TrackPMin" , cms.double(0.0) ),
        ("TrackProducer" , cms.InputTag("hltPhase2HighPurityPtRange0to1") ),
        ("TrackProducerForMVA" , cms.InputTag("hltPhase2InitialStepTracks") ),
        ("TrackPt2DBin" , cms.int32(100) ),
...
hltPhase2HighPurityPV0p1 = cms.EDProducer("TrackWithVertexSelector",
    copyExtras = cms.untracked.bool(False),
    copyTrajectories = cms.untracked.bool(False),
    d0Max = cms.double(999.0),
    dzMax = cms.double(999.0),
...
hltPhase2HighPurityPt1 = cms.EDFilter("TrackSelector",
    cut = cms.string("quality(\'highPurity\') & pt >= 1"),
    src = cms.InputTag("hltPhase2GeneralTracks")
)

hltPhase2HighPurityPtRange0to1 = cms.EDFilter("TrackSelector",
    cut = cms.string("quality(\'highPurity\') & pt >= 0 & pt < 1 "),
    src = cms.InputTag("hltPhase2GeneralTracks")
)

hltPhase2PrimaryVertexResolution = cms.EDProducer("PrimaryVertexResolution",
...
hltPhase2PvMonitor = cms.EDProducer("PrimaryVertexMonitor",
    ...
    ndof = cms.int32(4),
    vertexLabel = cms.InputTag("hltPhase2OfflinePrimaryVertices")
)
...
MC_Dqmoffline = cms.EndPath(cms.Task(hltPhase2PV0p1,hltPhase2TrackMon_ckf, hltPhase2TrackSeedMoninitialStep, hltPhase2TrackSeedMoninitialStep, TrackSplitMonitor, hltPhase2TrackerCollisionSelectedTrackMonCommongeneralTracks, hltPhase2TrackerCollisionSelectedTrackMonCommonhighPurityPV0p1, hltPhase2TrackerCollisionSelectedTrackMonCommonhighPurityPt1, hltPhase2TrackerCollisionSelectedTrackMonCommonhighPurityPtRange0to1,  dqmInfoTracking, hltPhase2HighPurityPV0p1, hltPhase2HighPurityPt1, hltPhase2HighPurityPtRange0to1, hltPhase2PrimaryVertexResolution, hltPhase2PvMonitor, hltPhase2TrackingDQMgoodOfflinePrimaryVertices))
