...
TrackSeedMondetachedQuadStep = cms.EDProducer("TrackingMonitor",
**dict(
    [
...
TrackSeedMonlowPtQuadStep = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
TrackSeedMonlowPtTripletStep = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
TrackSeedMonmuonSeededStepInOut = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
TrackSeedMonmuonSeededStepOutIn = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
TrackSeedMonpixelPairStep = cms.EDProducer("TrackingMonitor",
**dict(
    [
        ("AbsDxyBin" , cms.int32(120) ),
        ("AbsDxyMax" , cms.double(60.0) ),
...
MC_Dqmoffline_v0 = cms.EndPath(cms.Task(PV0p1,TrackMon_ckf, TrackSeedMondetachedQuadStep, TrackSeedMonhighPtTripletStep, TrackSeedMoninitialStep, TrackSeedMonlowPtQuadStep, TrackSeedMonlowPtTripletStep, TrackSeedMonmuonSeededStepInOut, TrackSeedMonmuonSeededStepOutIn, TrackSeedMonpixelPairStep, TrackSplitMonitor, TrackerCollisionSelectedTrackMonCommongeneralTracks, TrackerCollisionSelectedTrackMonCommonhighPurityPV0p1, TrackerCollisionSelectedTrackMonCommonhighPurityPt1, TrackerCollisionSelectedTrackMonCommonhighPurityPtRange0to1,  dqmInfoTracking, highPurityPV0p1, highPurityPt1, highPurityPtRange0to1, primaryVertexResolution, pvMonitor, trackingDQMgoodOfflinePrimaryVertices))
