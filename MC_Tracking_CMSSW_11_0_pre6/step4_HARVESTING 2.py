...
# with command line options: step4 --conditions auto:phase2_realistic_T14 -s HARVESTING:@trackingOnlyValidation+@trackingOnlyDQM --scenario pp --filetype DQM --geometry Extended2026D41 --era Phase2C8_timing_layer_bar --mc -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
