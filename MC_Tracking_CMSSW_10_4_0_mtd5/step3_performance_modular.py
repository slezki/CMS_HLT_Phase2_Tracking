...
#process.load("input_TTbar_PhaseIIMTDTDRAutumn18DR-PU200_103X_upgrade2023_realistic_v2-v1_cff")
...
process.schedule = cms.Schedule(*[ process.raw2digi_step, process.MC_Tracking_v2, process.MC_prevalidation_v2, process.MC_Dqmoffline_v2, process.DQMoutput_step ])
