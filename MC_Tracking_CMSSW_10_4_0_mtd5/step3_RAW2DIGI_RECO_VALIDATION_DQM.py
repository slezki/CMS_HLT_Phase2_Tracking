...
process = cms.Process('PERFORMANCE',eras.Phase2)
...
process.load("input_TTbar_PhaseIIMTDTDRAutumn18DR-noPU_103X_upgrade2023_realistic_v2-v1_cff")
...
process.load('MC_Tracking_v0_cff')
process.load('MC_prevalidation_v0_cff')  
process.load('MC_Dqmoffline_v0_cff')


###########################################################################################
# Schedule definition
process.schedule = cms.Schedule( *[process.raw2digi_step,process.MC_Tracking_v0,process.MC_prevalidation_v0, process.MC_Dqmoffline_v0, process.DQMoutput_step])
