...
hltPhase2TrackValidator = cms.EDProducer("MultiTrackValidator",
...
hltPhase2TrackValidatorL1 = hltPhase2TrackValidator.clone(
    cores = cms.InputTag("highPtJetsForTrk"),
...
hltPhase2TrackValidatorTPPtLess09Standalone = hltPhase2TrackValidator.clone(
