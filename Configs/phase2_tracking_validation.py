...
def customise_common(process):
    ...
    process.initialStepTrackCandidates = CkfTrackCandidateMaker.clone(
    ...
    process.highPtTripletStepTrackCandidates = process.initialStepTrackCandidates.clone(
    ...
    process.highPtTripletStepSeeds = EDProducer('SeedCreatorFromRegionConsecutiveHitsEDProducer',
